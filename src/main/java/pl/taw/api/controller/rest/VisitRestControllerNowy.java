...
@RestController
@RequestMapping(VisitRestControllerNowy.API_VISITS)
@AllArgsConstructor
public class VisitRestControllerNowy {

    public static final String API_VISITS = "/api/visits/nowy";
...
//    public ResponseEntity<Void> deleteVisitXXX(@PathVariable("visitId") Integer visitId) {
//        VisitEntity existingVisit = visitDAO.findEntityById(visitId);
//        if (existingVisit != null) {
