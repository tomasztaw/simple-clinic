...
class DoctorServiceMockitoTest {
    ...
    void getDoctorSpecializations() {
        ...
        when(doctorDAO.findAllSpecializations()).thenReturn(specializations);
        ...
        verify(doctorDAO, times(1)).findAllSpecializations();
        verify(doctorDAO, only()).findAllSpecializations();
    }
    ...
    void getWorkingHours() {
        ...
        when(doctorScheduleDAO.findScheduleByDoctorId(doctorId)).thenReturn(doctorSchedules);
        ...
        verify(doctorScheduleDAO, times(1)).findScheduleByDoctorId(doctorId);
        verify(doctorScheduleDAO, only()).findScheduleByDoctorId(doctorId);
